// Password gate for the case studies (/work/*), ported from the Netlify edge function.
// The password lives in the CASE_STUDY_PASSWORD environment variable on Vercel.
...
function page({ path, error, unconfigured }) {
  const message = unconfigured
    ? `<p class="gate-error" role="alert">The case-study password isn't configured yet. Set CASE_STUDY_PASSWORD in Vercel and redeploy.</p>`
    : error
